...
def plot_wavelet_comparison(record_num='100', start_sample=0, end_sample=2000, fs=360):
    """
    绘制小波变换前后信号对比图
    ...
    filtered_signal = bandpass_filter(wavelet_signal, fs=fs, lowcut=0.5, highcut=40.0, order=5)
...
if __name__ == "__main__":
    ...
    # MIT-BIH数据库的采样频率通常是360Hz
    sampling_frequency = 360

    # 绘制小波变换前后对比
    print(f"\n1. 绘制小波变换和带通滤波信号处理流程图...")
    plot_wavelet_comparison(record_number, start_sample=start_sample, end_sample=end_sample, fs=sampling_frequency)
